...
sed 's/GUID_VARIABLE/oss/g;s/CLUSTER_VARIABLE/mycluster.com/g' ../templates/mlbparks-pipeline_template_build.yaml | oc process -f - | oc create -f -
sed 's/GUID_VARIABLE/oss/g;s/CLUSTER_VARIABLE/mycluster.com/g' ../templates/nationalparks-pipeline_template_build.yaml | oc process -f - | oc create -f -
sed 's/GUID_VARIABLE/oss/g;s/CLUSTER_VARIABLE/mycluster.com/g' ../templates/parksmap-pipeline_template_build.yaml | oc process -f - | oc create -f -
